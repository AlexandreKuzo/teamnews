...
<div class="card-content">
    ...
    <form action="{{ route('affaires') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
                    <div class="field">
...
<div class="card">
  ...
  <footer class="card-footer">
    ...
    <script>
      ...
      var linkAffaires = document.getElementbyId("supp_affaires");
      supp_affaires.onclick = function {
